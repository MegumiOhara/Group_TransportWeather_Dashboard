...
const getIncidentIcon = (type: string) => {
   switch (type.toLowerCase()) {
      ...
      case "avstängning":
         return (
            <FontAwesomeIcon icon={faRoadCircleXmark} className="text-xl" />
         );
      case "väder":
                  ...
                  <div className="space-y-3">
                     <div className="flex items-center justify-between">
                        ...
                        {incident.severity !== "Unknown" && (
                           <span
                              className={`inline-flex px-3 py-1 text-xs font-medium rounded-full ml-2 whitespace-nowrap ${getSeverityStyles(
                                 incident.severity
                              )}`}>
                              {incident.severity}
                           </span>
